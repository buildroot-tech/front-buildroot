            ...
            <div className="w-full flex flex-col gap-0 items-end">
              ...
              <div className="flex flex-wrap items-end justify-end w-full py-[clamp(0.1rem,0.3vw,0.4rem)] gap-2 md:gap-3">
                <div className="flex items-end gap-0.5 md:gap-1 shrink-0">
                  <svg
                    ...
                    stroke="currentColor"
                    strokeWidth="1.5"
                    className="text-[var(--text-primary)] shrink-0 w-[clamp(0.95rem,4.2vw,5rem)] h-[clamp(0.95rem,4.2vw,5rem)] md:w-[clamp(1.5rem,3.8vw,5rem)] md:h-[clamp(1.5rem,3.8vw,5rem)]"
                  >
                ...
                <div className="flex items-center gap-1 md:gap-2 shrink-0">
                  ...
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="text-emerald-500 shrink-0 w-[clamp(0.95rem,4.2vw,5rem)] h-[clamp(0.95rem,4.2vw,5rem)] md:w-[clamp(1.5rem,3.8vw,5rem)] md:h-[clamp(1.5rem,3.8vw,5rem)]"
                  >
                    <path d="M17.5 20H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z" />
                  </svg>
                </div>

                <div className="flex items-center gap-1 font-display text-[clamp(0.7rem,2.8vw,1.8rem)] md:text-[clamp(1.1rem,1.8vw,1.8rem)] uppercase font-normal tracking-tighter text-[var(--text-primary)] shrink-0 self-center">
                  {/* ↗ arrow */}
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <div className="flex flex-wrap items-center justify-end w-full py-[clamp(0.1rem,0.3vw,0.4rem)] gap-2 md:gap-3">
                ...
                <div className="flex w-fit border-[2px] border-[var(--border)] min-w-0 shrink-0">
                  ...
                  <div className="flex items-center justify-center text-center font-display text-[clamp(0.65rem,2.6vw,1.7rem)] md:text-[clamp(0.9rem,1.3vw,1.7rem)] leading-none tracking-tighter font-normal text-[var(--text-primary)] py-0 md:py-0.5 px-2 md:px-3 whitespace-nowrap">
                  ...
                  <div className="flex flex-col w-fit">
                    <div className="w-full flex items-center justify-center text-center font-display text-[clamp(0.65rem,2.6vw,1.7rem)] md:text-[clamp(0.9rem,1.3vw,1.7rem)] leading-none tracking-tighter font-normal text-[var(--text-primary)] py-0 md:py-0.5 px-2 md:px-3">
                ...
                >
                  <span className="font-serif font-light text-[var(--text-primary)] text-[clamp(0.95rem,4.2vw,5rem)] md:text-[clamp(1.5rem,3.8vw,5rem)] leading-[0.85] tracking-tighter group-hover:bg-[var(--text-primary)] group-hover:text-[var(--bg-primary)] transition-colors duration-300 py-1 lowercase">
                    {contactInfo.email}
                  </span>
                </a>
              </div>

  ...
  const floatingItems = React.useMemo(() => [
    {
      ...
      className: "top-[15%] left-[5%] md:top-[20%] md:left-[10%] items-start text-left",
      start: 100, end: 800,
    },
    {
      id: 2,
      ...
      className: "top-[10%] right-[5%] md:top-[15%] md:right-[15%] items-end text-right",
      start: 400, end: 1000,
    },
    {
      id: 3,
      line1: dict?.based_in || "BASED IN",
      line2: dict?.location || "IPIALES, COLOMBIA",
      className: "top-[50%] left-[5%] md:left-[10%] -translate-y-1/2 items-start text-left",
      start: 900, end: 1500,
    },
    {
      id: 4,
      ...
      className: "bottom-[25%] right-[5%] md:bottom-[30%] md:right-[10%] items-end text-right",
      start: 500, end: 1100,
    },
    {
      id: 5,
      line1: dict?.based_in || "BASED IN",
      line2: dict?.location || "IPIALES, COLOMBIA",
      className: "top-[50%] right-[5%] md:right-[10%] -translate-y-1/2 items-end text-right",
      start: 1100, end: 1700,
    },
    {
      id: 6,
